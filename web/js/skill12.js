var tblPosts = document.getElementById('tbl_posts_list');
  var databaseRef = firebase.database().ref('otherskills/');
  var rowIndex = 1;
...
//function for button for saving posts to the database
  function save_post(){
   ...
   var uid = firebase.database().ref().child('otherskills').push().key;
...
var roofRef = firebase.database().ref().child("otherskills");
