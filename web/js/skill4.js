var tblPosts = document.getElementById('tbl_posts_list');
  var databaseRef = firebase.database().ref('hardwaresoftwareskills/');
  var rowIndex = 1;
  ...
  function save_post(){
   ...
   var updates = {};
   updates['/hardwaresoftwareskills/' + uid] = data;
...
var roofRef = firebase.database().ref().child("hardwaresoftwareskills");
