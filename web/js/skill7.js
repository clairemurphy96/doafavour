var tblPosts = document.getElementById('tbl_posts_list');
  var databaseRef = firebase.database().ref('babysittingskills/');
  var rowIndex = 1;
  ...
  function save_post(){
   ...
   var uid = firebase.database().ref().child('babysittingskills').push().key;
   ...
   var updates = {};
   updates['/babysittingskills/' + uid] = data;
...
var roofRef = firebase.database().ref().child("babysittingskills");
