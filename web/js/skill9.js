var tblPosts = document.getElementById('tbl_posts_list');
  var databaseRef = firebase.database().ref('photographyskills/');
  var rowIndex = 1;
  ...
  function save_post(){
   ...
   var uid = firebase.database().ref().child('photographyskills').push().key;
...
var roofRef = firebase.database().ref().child("photographyskills");
